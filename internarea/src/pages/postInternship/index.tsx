...
const index = () => {
  ...
  const handlesubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/internship`, { ...formData, postedBy: user.uid });
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600">
              {t("Create a new internship opportunity for students")}
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="text-black mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  placeholder={t("e.g. ₹15,000/month") as string}
                />
              </div>
